...
public enum ConfluenceStorageRenderer {
    public static func render(
        ...
        // The optional transcript is deliberately the final page element and
        // collapsed by default: useful when needed, invisible to the main
        // reading flow otherwise.
        if includeTranscript, !transcript.trimmingCharacters(in: .whitespacesAndNewlines).isEmpty {
            let body = transcript
